...
// configuration step. It creates a namespace called `Drogon_test`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Drogon_test::cmake::project_name, Drogon_test::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", Drogon_test::cmake::project_version);
      return EXIT_SUCCESS;
    }
